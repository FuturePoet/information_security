...
public class DMonofram extends javax.swing.JFrame {
  public static String PreparingKey (String Key){
    ...
    public static String Decrypt_MonoChipher (String Key, String Alpha, String Text){
        
        String DecryptionText = "";
        
        for(int i=0; i<Text.length(); i++){
            int Index = Key.indexOf(Text.charAt(i));
            DecryptionText += Alpha.charAt(Index);
            
        }
        
        String x="\nThe Decryption Text is : "+DecryptionText;
        return x;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       k= k.toUpperCase();
        ...
        pt = pt.toUpperCase();
        k = PreparingKey(k);
        String x =Decrypt_MonoChipher(k,Alpha,pt);
