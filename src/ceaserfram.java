...
public class ceaserfram extends javax.swing.JFrame {
...
// Function to Encrypt the text
    public static String encryptionCeaserCipher(String text, String key) {
        ...
        for (char character : text.toCharArray()) {
            ...
            } else if (Character.isUpperCase(character) && ((int) character + keyInt) > 90) {
                encryption.append((char) ((int) character - (26 - keyInt)));
            } else if (Character.isLowerCase(character) && ((int) character + keyInt) > 122) {
                encryption.append((char) ((int) character - (26 - keyInt)));
            } else {
                encryption.append((char) ((int) character + keyInt));
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Dycrpted Text ");
        jLabel5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 220, 60));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       strToInt(k);
       String x=encryptionCeaserCipher(pt,k);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ceaserfram().setVisible(true);
            }
        });
    }
