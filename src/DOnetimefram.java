 ...
 * @author Dell
 */
public class DOnetimefram extends javax.swing.JFrame {

     public static String decryptionOneTimePad(String text, String key) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("One Time Pad");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 20, 300, 50));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       pt.toUpperCase();
       k.toUpperCase();
       String x=decryptionOneTimePad(pt,k);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DOnetimefram().setVisible(true);
            }
        });
    }
