 ...
 * @author Dell
 */
public class DRailfranceFram extends javax.swing.JFrame {
public static String decryptionRailFence(String text, int key) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 190, 60));
 ...
 String pt=plaintext.getText();
       ...
       String x=decryptionRailFence(pt,k);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DRailfranceFram().setVisible(true);
            }
        });
    }
