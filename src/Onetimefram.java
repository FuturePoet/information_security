 ...
 * @author Dell
 */
public class Onetimefram extends javax.swing.JFrame {

   public static String encryptionOneTimePad(String text, String key) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       pt.toUpperCase();
       k.toUpperCase();
       String x=encryptionOneTimePad(pt,k);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Onetimefram().setVisible(true);
            }
        });
    }
